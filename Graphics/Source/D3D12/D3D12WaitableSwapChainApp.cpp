...
void D3D12WaitableSwapChainApp::OnFinalize()
{
	waitForGPU(m_gfx_cmd_queue.Get());
}

void D3D12WaitableSwapChainApp::OnUpdate()
{
}
...
void D3D12WaitableSwapChainApp::reset()
{
...
void D3D12WaitableSwapChainApp::setViewport(float width, float height)
{
...
void D3D12WaitableSwapChainApp::setScissorRect(LONG width, LONG height)
{
	D3D12_RECT scissor = {
		.left   = 0,
		.top    = 0,
...
void D3D12WaitableSwapChainApp::setBackBuffer()
{
...
void D3D12WaitableSwapChainApp::executeCommandList()
{
	D3D12_RESOURCE_BARRIER barrier = {};
	{
		barrier.Type                   = D3D12_RESOURCE_BARRIER_TYPE_TRANSITION;
...
void D3D12WaitableSwapChainApp::present(UINT sync_interval)
{
...
void D3D12WaitableSwapChainApp::waitPreviousFrame()
{
...
void D3D12WaitableSwapChainApp::waitForGPU(ID3D12CommandQueue* cmd_queue)
{
...
bool D3D12WaitableSwapChainApp::createCommandQueue(
...
bool D3D12WaitableSwapChainApp::createCommandAllocator(
    const D3D12_COMMAND_LIST_TYPE type,
...
bool D3D12WaitableSwapChainApp::createCommandList(
    const D3D12_COMMAND_LIST_TYPE type,
    ID3D12CommandAllocator*       cmd_allocator,
...
bool D3D12WaitableSwapChainApp::createDescriptorHeap(
...
bool D3D12WaitableSwapChainApp::createTexture2D(
