...
bool D3D12TextureApp::OnInitialize()
{
	...
	ComPtr<IDxcBlob> vs;
	if (!loadShader(L"../../Win32/HLSL/PositionTexcoord_vs.hlsl", L"main", L"vs_6_0", vs.GetAddressOf()))
		return false;

	ComPtr<IDxcBlob> ps;
	if (!loadShader(L"../../Win32/HLSL/PositionTexcoord_ps.hlsl", L"main", L"ps_6_0", ps.GetAddressOf()))
		return false;
