...
bool D3D11TextureApp::OnInitialize()
{
	...
	ComPtr<ID3DBlob> vs;
	if (!loadShader(L"../../Win32/HLSL/PositionTexcoord_vs.hlsl", "main", "vs_5_0", vs.GetAddressOf()))
		return false;

	ComPtr<ID3DBlob> ps;
	if (!loadShader(L"../../Win32/HLSL/PositionTexcoord_ps.hlsl", "main", "ps_5_0", ps.GetAddressOf()))
		return false;
